    ...
    const audioWithUrls = audioEntries.map(entry => {
      ...
      return {
        ...
        ru: {
          ...
          smallaudio: "https://s3.us-east-005.backblazeb2.com/audio-uploads/" + extractFileName(entry.ru.smallaudio),
          image: "https://s3.us-east-005.backblazeb2.com/audio-uploads/" + extractFileName(entry.ru.image),
          video: "https://s3.us-east-005.backblazeb2.com/audio-uploads/" + extractFileName(entry.ru.video),
        ...
        uz: {
          ...
          smallaudio: "https://s3.us-east-005.backblazeb2.com/audio-uploads/" + extractFileName(entry.uz.smallaudio),
          image: "https://s3.us-east-005.backblazeb2.com/audio-uploads/" + extractFileName(entry.uz.image),
          video: "https://s3.us-east-005.backblazeb2.com/audio-uploads/" + extractFileName(entry.uz.video),
